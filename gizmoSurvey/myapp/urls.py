...
urlpatterns = [
    ...
    path('teacher/student/<int:student_id>/profile/', views.view_student_profile, name='view_student_profile'),
    path('teacher/student/<int:student_id>/responses/', views.student_responses, name='student_responses'),
